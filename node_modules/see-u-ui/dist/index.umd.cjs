(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue")) : typeof define === "function" && define.amd ? define(["exports", "vue"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.SeeYouUI = {}, global.Vue));
    ...
    setup(__props, { emit: __emit }) {
      ...
      const activeWaves = (e) => {
        getClientRect().then((data) => {
          ...
          vue.nextTick(() => active.value = true);
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", {
          id: seeButtonId,
          style: vue.normalizeStyle({ ...props.customStyle, borderRadius: props.radius + "px" }),
          class: vue.normalizeClass(["see-button", [props.size]]),
          ...
          vue.createElementVNode("view", {
            ...
            vue.createElementVNode("button", {
              ...
              class: vue.normalizeClass(["see-botton-class", [
                props.size,
            ...
            props.isRipple ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 0,
              class: vue.normalizeClass(["see-button-ripple", { active: active.value }]),
              style: vue.normalizeStyle({
                ...props.rippleStyle,
  ...
  function useDateFormat(date, formatStr = "YYYY-MM-DD HH:mm:ss", options = { placeholder: "" }) {
    return vue.computed(() => {
      return formatDate(vue.unref(date), vue.unref(formatStr), options);
    });
  }
  ...
  function useTimeAgo(date, updateInterval = 3e4) {
    ...
    return vue.computed(() => {
      tick.value;
      return formatTimeAgo(vue.unref(date));
    });
  }
    ...
    setup(__props, { emit: __emit }) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", {
          ...
          props.mode === "text" ? (vue.openBlock(), vue.createElementBlock("text", {
            key: 0,
            class: vue.normalizeClass(getClass.value),
            style: vue.normalizeStyle(getStyle.value)
          }, vue.toDisplayString(props.text), 7)) : vue.createCommentVNode("", true),
          props.mode === "link" ? (vue.openBlock(), vue.createBlock(SeeLink, {
            key: 1,
            text: props.text,
            type: props.type,
            href: props.href,
          ...
          props.mode === "price" ? (vue.openBlock(), vue.createElementBlock("text", {
            key: 3,
            class: vue.normalizeClass(getClass.value),
            style: vue.normalizeStyle(getStyle.value)
          }, vue.toDisplayString(vue.unref(formatCurrency)(props.text)), 7)) : vue.createCommentVNode("", true),
          props.mode === "date" ? (vue.openBlock(), vue.createElementBlock("text", {
            key: 4,
            class: vue.normalizeClass(getClass.value),
            style: vue.normalizeStyle(getStyle.value)
          }, vue.toDisplayString(vue.unref(formatDate)(props.date, props.dateFormat)), 7)) : vue.createCommentVNode("", true),
          props.mode === "timeago" ? (vue.openBlock(), vue.createElementBlock("text", {
            key: 5,
            class: vue.normalizeClass(getClass.value),
            style: vue.normalizeStyle(getStyle.value)
          }, vue.toDisplayString(vue.unref(formatTimeAgo)(props.date)), 7)) : vue.createCommentVNode("", true)
        ]);
      };
    }
  });
  ...
  exports2.SeeButton = SeeButton;
  exports2.SeeLink = SeeLink;
  exports2.SeeText = SeeText;
  exports2.default = index;
  exports2.formatCurrency = formatCurrency;
  exports2.formatDate = formatDate;
  exports2.formatTimeAgo = formatTimeAgo;
  exports2.useCurrencyFormat = useCurrencyFormat;
